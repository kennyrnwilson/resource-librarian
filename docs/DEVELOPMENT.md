...
For detailed documentation of all source module methods, see the **[API Reference](api/index.md)**.

**Quick Links:**
- **[book_parser.py](api/book_parser.md)** - Multi-format text extraction (PDF, EPUB, Markdown)
- **[book_ingestion.py](api/book_ingestion.md)** - Add books to library with automatic organization
- **[book_folder_scanner.py](api/book_folder_scanner.md)** - Scan structured book folders
- **[epub_chapter_extractor.py](api/epub_chapter_extractor.md)** - Extract individual EPUB chapters
